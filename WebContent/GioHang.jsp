...
<form action="GioHangController" method="post">
			...
			for (GioHangBean ht: ds) {%>
				<tr>
					...
					<td>
						...
						<button class ="btn btn-outline-primary" type="submit" name="btnAdd" value="<%=ht.getMaSach()%>">Cập nhật</button>
	...
	<div class="container clearfix">
		<button type='submit' class="text-right btn btn-light" name='delCheckbox' value='Xóa'>Xóa giỏ hàng</button>
